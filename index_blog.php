...
<body class="bg-light">
    <div class="container bg-white text-light p-3 rounded my-4  shadow">
        <div class="d-flex align-items-center justify-content-between mx-3">
            <h2>
                <a href="index_blog.php" class="text-dark text-decoration-none">
                    <i class="bi bi-bar-chart-fill"></i> Blogs
                </a>
            </h2>
    ...
    <div class="container mt-5 p-0 shadow">
        <table class="table table-hover text-center">
            <thead class="bg-white text-dark shadow">
                <tr>
    ...
    <div class="modal fade" id="addproduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <form action="crud_blog.php" method="post" enctype="multipart/form-data">
    ...
    if (isset($_GET['edit']) && $_GET['edit'] > 0) {
        $query = "SELECT * FROM `blog` WHERE `Id`='$_GET[edit]'";
        $result = mysqli_query($con, $query);
    ...
    <script>
        function confirm_rem(Id) {
            if (confirm("Are you sure, you want to delete item ?")) {
                window.location.href = "crud_blog.php?rem=" + Id;
            }
        }
    </script>
</body>
