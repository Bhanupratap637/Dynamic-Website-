...
<body class="bg-light">
        ...
        <div class="d-flex align-items-center justify-content-between mx-3">
            <h2>
                <a href="index.php" class="text-dark text-decoration-none">
                    <i class="bi bi-bar-chart-fill"></i> Reviews
                </a>
            </h2>
    ...
    <div class="modal fade" id="addproduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <form action="crud_testimonial.php" method="post" enctype="multipart/form-data">
    ...
    <script>
        function confirm_rem(Id) {
            if (confirm("Are you sure, you want to delete item ?")) {
                window.location.href = "crud_testimonial.php?rem=" + Id;
            }
        }
    </script>
</body>
